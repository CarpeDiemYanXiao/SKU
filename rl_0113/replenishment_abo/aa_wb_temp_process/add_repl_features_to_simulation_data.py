...
print(1)
pred_df_path="/home/work/apb-project/ais-deploy-demo-cache/ais-deploy-demo/outs/cache/rl_0415_dq2_new/tft_stream/simulation_65.v202505.parquet"
static_df_path="/home/work/apb-project/ais-deploy-demo-cache/replenishment_wb/replenishment_ppo/data/simulation/20250728_static_feature"
result_df_path="/home/work/apb-project/ais-deploy-demo-cache/replenishment_wb/replenishment_ppo/data/simulation/20250728_whole_data_May.parquet"
print(2)
static_df=pd.read_parquet(static_df_path)
print(3)
pred_df=pd.read_parquet(pred_df_path)
