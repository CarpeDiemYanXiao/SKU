...
###05数据
# pred_df_path="/home/work/apb-project/ais-deploy-demo-cache/ais-deploy-demo/outs/cache/rdc_0810_dq1/tft_stream/simulation_65_sub.v1_dq2.parquet"
# static_df_path="/home/work/apb-project/ais-deploy-demo-cache/replenishment_wb/simulation_data/20251103_static_feature/tmp_7_cache_static_1103"
# result_df_path="/home/work/apb-project/ais-deploy-demo-cache/replenishment_wb/simulation_data/20251103_whole_date_v1"
# print('加载静态特征')
# static_df=pd.read_parquet(static_df_path)
# static_df = static_df[static_df['ds'] <= '2025-09-12'] # 超出两天，防止出错❗️，这里要改❗️还有下面
# print('加载预测值')
# pred_df=pd.read_parquet(pred_df_path)
# print("data_loaded")
# pred_df=pd.merge(pred_df,static_df,how="left",on=["idx","ds"])
...
pred_df_path="/home/work/apb-project/ais-deploy-demo-cache/ais-deploy-demo/outs/cache/rdc_0810_dq1/tft_stream/simulation_65_sub.v2_dq2.parquet"
static_df_path="/home/work/apb-project/ais-deploy-demo-cache/replenishment_wb/simulation_data/20251103_static_feature/tmp_7_cache_static_1103"
result_df_path="/home/work/apb-project/ais-deploy-demo-cache/replenishment_wb/simulation_data/20251103_whole_date_v2"

print('加载静态特征')
static_df=pd.read_parquet(static_df_path)
# static_df = static_df[static_df['ds'] >= '2025-09-09'] # 超出两天，防止出错❗️
print('加载预测值')
pred_df=pd.read_parquet(pred_df_path)
print("data_loaded")
pred_df=pd.merge(pred_df,static_df,how="left",on=["idx","ds"])
