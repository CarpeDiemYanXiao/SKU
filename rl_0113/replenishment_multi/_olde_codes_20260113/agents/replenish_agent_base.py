...
class ReplenishAgent:
    ...
    def use_train_env(self):
        ...
        # 商品清单
        # self.avg_item_qty_7d_map = self.train_env.datasets.avg_item_qty_7d_map 先注释掉，跑base
    ...
    def update(self):
        ...
        # if not self.distributed or self.is_master: # 不在这里保存了，每50个episode保存一次模型
    ...
    def train(self):
        ...
        for episode in range(self.start_episode, self.max_episodes):
            ...
            if not self.distributed or self.is_master:
                ...
                self.logger.add_scalar("bind_reward",train_total_bind*self.config.coverage_weight,episode)
